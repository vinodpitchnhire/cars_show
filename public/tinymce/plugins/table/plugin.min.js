...
!(function () {
  ...
  function Wn(e, n, t) {
    return e.isSome() && n.isSome()
      ? q.some(t(e.getOrDie(), n.getOrDie()))
      : q.none();
  }
  function jn(e, n) {
        ...
        .map(function (e) {
          var o,
            ...
            n =
              ...
              o);
          return {
            colgroups: [{ element: e.element, columns: de(n) }],
            columns: n,
          };
        })
        .getOrThunk(function () {
    ...
    return ce(c, l)
      ...
      : nr(c).bind(function (i) {
          return nr(l).bind(function (u) {
            ...
            if (le(i, u)) {
              var e =
                0 < (n = sn(l, "td,th", f(i))).length ? n[n.length - 1] : l;
  ...
  function gr(e, n, t) {
    return (
      ...
      (o = t),
      (u = parseFloat(r)),
      (isNaN(u) ? q.none() : q.some(u)).getOr(o)
    );
    var r, o, u;
  }
  function pr(e) {
      ...
      mergable:
        ...
        cr(
          ...
          function (n) {
            return n.length <= 1
              ? q.none()
              : ir(u, i.firstSelectedSelector, i.lastSelectedSelector).map(
                  function (e) {
  ...
  function Vu(o) {
    ...
    var g = Au(o.parent(), "mousedown", function (e) {
        Mu(e.target, va) && m(e.target, "top"),
          Mu(e.target, wa) && m(e.target, "left");
      }),
        ...
        .map(function (e) {
          ...
          return (
            ka(u)
              ...
              : Ia(u)
              ? Ea(e)
              : (ui(u) || ((n = o.width), T(n) && -1 !== n.indexOf("%"))) &&
                Ba(e),
            nu(e),
            Wt(e, "data-mce-id"),
            (t = u),
  ...
  function dl(e, n) {
    ...
    0 !== i.length &&
      ...
      (o = {
        type: "tabpanel",
        tabs: [
          { title: "General", name: "general", items: ol(e) },
          ul(e, "cell"),
        ],
      }),
      (u = {
        type: "panel",
        items: [{ type: "grid", columns: 2, items: ol(e) }],
      }),
  ...
  function bl(i) {
    ...
    0 !== l.length &&
      ...
      (u = {
        type: "tabpanel",
        tabs: [
          { title: "General", name: "general", items: gl(i) },
          ul(i, "row"),
        ],
      }),
      (c = {
        type: "panel",
        items: [{ type: "grid", columns: 2, items: gl(i) }],
      }),
        ...
        f(function (e, n) {
          var t,
            ...
            u =
              ((t = i),
              (r = o),
              { selection: ru(a), clipboard: t, generators: r });
          c(e, u).each(s);
        });
      });
    }
  ...
  function Nl(o, u) {
    function r(e) {
      if (sc(e))
        return Ka((t = { element: e }).element) ? o.colgroup(t) : o.row(t);
      var n,
        t,
    ...
    vf = zi(
      function (e, n, t, r) {
        var o,
          u,
          i =
            ((o = n.clipboard), (u = n.generators), Mi($t.fromTable(o), u, !0));
  ...
  function ps(e) {
    ...
    return (
      ...
      (s = ce(n, r) && t === o),
      f.collapsed && !s
        ? q.some(Gf(m, e.anchorOffset, d, e.focusOffset))
        : gs(e)
    );
  }
  function bs(e, n, t) {
  ...
  function Xs(o, u, n) {
    ...
    return {
      ...
      selectRange: function (e, n, t, r) {
        c(e),
          A(n, i),
          Mn(t, o.firstSelected, "1"),
          Mn(r, o.lastSelected, "1"),
          u(n, t, r);
      },
    ...
    Js = document.caretPositionFromPoint
      ? function (t, e, n) {
          ...
          return q
            ...
            .bind(function (e) {
              ...
              var n = t.dom.createRange();
              return (
                n.setStart(e.offsetNode, e.offset), n.collapse(), q.some(n)
              );
            });
        }
      ...
      : function (o, u, n) {
          return Ve.fromPoint(o, u, n).bind(function (r) {
            function e() {
              return (
                (e = o), (t = u), (0 === ln((n = r)).length ? os : rs)(e, n, t)
              );
              var e, n, t;
            }
        ...
        : tr(r, n, e).bind(function (e) {
            ...
            return 1 < n.length
              ? (o(t, n, e.start, e.finish),
                q.some(nm(q.some(rm(r, 0, r, Lo(r))), !0)))
              : q.none();
          });
    },
    um = function (e, n, t, r) {
              ...
              i =
                ...
                _i((u = $t.fromTable(e)), n).map(function (e) {
                  ...
                  return {
                    ...
                    downOrRightCells: N(
                      Ei(r.slice((t = e)[0].row + t[0].rowspan - 1, r.length)),
                      function (e) {
                        return O(
                          e.cells.slice(
      ...
      I.on("init", function (e) {
                        ...
                        return H(e, function (e) {
                          ...
                          function () {
                            return or(
                              ...
                              var n =
                                Om(c) || i.isForward(c) ? Kf.after : Kf.before;
                              return (
        ...
        I.on("dragstart", function (e) {
          ...
          I.on("keydown", function (e) {
            ...
            C.keydown(n, r, t.startOffset, o, t.endOffset, u).each(
              function (e) {
                R(n, e);
              },
            ),
      ...
      c.getParam("table_tab_navigation", !0, "boolean") &&
        c.on("keydown", function (e) {
          ...
          (n = e).keyCode === Qs.TAB &&
            ...
            et(
              Ve.fromDom(n.shiftKey ? o.startContainer : o.endContainer),
              r,
            ).each(function (e) {
              n.preventDefault(),
                rt(e, r).each(i.clear),
