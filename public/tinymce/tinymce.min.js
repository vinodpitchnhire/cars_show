...
!(function () {
  ...
  var kn = At(1),
    ...
    In = function (e) {
      ...
      var n = t.ownerDocument,
        r = Nt.fromDom(t),
        o = Bn(r);
      return (Ht(o) ? ve.some(o) : ve.none()).fold(
        function () {
  ...
  function Pr(e) {
    return (
      Eo(e) && (e = e.parentNode), So(e) && e.hasAttribute("data-mce-caret")
    );
  }
  function Lr(e) {
  ...
  function jr(e) {
    return (
      !Po(e) && (Do(e) ? !To(e.parentNode) : Oo(e) || Ro(e) || Bo(e) || Lo(e))
    );
  }
  function Vr(e, t) {
    return (
  ...
  function ua() {
    ...
    function r(e, t) {
      return (
        n.push(e + " ") > li.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    }
    return r;
  ...
  (ci = aa.support = {}),
    ...
    (aa.attr = function (e, t) {
      ...
      var n = li.attrHandle[t.toLowerCase()],
        r =
          n && Li.call(li.attrHandle, t.toLowerCase()) ? n(e, t, !wi) : void 0;
      return void 0 !== r
        ? r
        : ci.attributes || !wi
        ? e.getAttribute(t)
            ...
            ((i = (function e(t) {
              for (
                ...
                if ((n = li.relative[t[s].type])) f = [ga(pa(f), n)];
                  ...
                  if (
                    (n = li.filter[t[s].type].apply(null, t[s].matches))[ki]
                  ) {
    ...
    (pi = aa.select =
      function (e, t, n, r) {
        ...
        return (
          (c || gi(e, l))(r, t, !wi, n, (ra.test(e) && fa(t.parentNode)) || t),
          n
        );
      }),
  ...
  function Ha(e, t, n) {
    var r = [],
      o = e[t];
    for (
      "string" != typeof n && n instanceof Wa && (n = n[0]);
      o && 9 !== o.nodeType;
      ...
      var _,
        ...
        $ = {
          ...
          getOuterHTML: function (e) {
            ...
            return zn(t)
              ? t.outerHTML
              : Wa("<div></div>").append(Wa(t).clone()).html();
          },
  ...
  function Ru(e, t) {
    ...
    return (
      e.bottom - n < t.top ||
      (!(e.top > t.bottom) && Au(t.top - e.bottom, e, t))
    );
  }
  function Du(e, t) {
    return (
      e.top > t.bottom || (!(e.bottom < t.top) && Au(t.bottom - e.top, e, t))
    );
  }
  function Tu(e, t, n) {
  ...
  function bs(e, t, n) {
    ...
    var a,
      ...
      d,
      m =
        vs((a = i).startContainer, a.startOffset) ||
        vs(a.endContainer, a.endOffset);
    return m
      ...
      show: function (e, t) {
        ...
        return (
          ...
          (c = _r.setInterval(function () {
            u()
              ? Wa("div.mce-visual-caret", i).toggleClass(
                  "mce-visual-caret-hidden",
                )
              : Wa("div.mce-visual-caret", i).addClass(
                  "mce-visual-caret-hidden",
                );
          }, 500)),
  ...
  function Sl(e, t, n, r) {
    ...
    return (
      ...
      (dl(c) || c.block_expand) &&
        ...
        (dl(c) && jn(a) && u !== a.nodeValue.length) ||
          (a = xl(s, n, a, u, !1))),
      ml(c) &&
        ((o = yl(s, n, t, o, "previousSibling")),
  ...
  var zl,
    ...
    ff = function (e, t, n, r) {
      var o = n.parentNode;
      return (
        !V(n[r]) && (!(o !== t && !K(o) && !e.isBlock(o)) || ff(e, t, o, r))
      );
    },
    df = function (t) {
  ...
  function td(e) {
    return (
      void 0 === e && (e = Nt.fromDom(document)),
  ...
  function rd(e) {
    return Bd.range(
      e.start,
      nd(e.soffset, e.start),
      e.finish,
      nd(e.foffset, e.finish),
    );
  }
  function od(e, t) {
  ...
  function cm(e) {
    ...
    return (
      jn(t) &&
      (0 === t.data.length || (xo(t.data) && Fl.isBookmarkNode(t.parentNode)))
    );
  }
  function lm(t, n) {
    return function (e) {
  ...
  function Em(e, t) {
    return (
      ve.from(t.getNode(!0)).map(Nt.fromDom).exists(Br) || wm(!1, e, t).isSome()
    );
  }
  function Nm(e) {
  ...
  function Hm(e, t) {
    return (
      ...
      (o = (n = t).container()),
      (i = n.offset()),
      !1 === as.isTextPosition(n) &&
      o === r.parentNode &&
      i > as.before(r).offset()
  ...
  function jm(e) {
    return jr(e.previousSibling)
      ? ve.some(
          ((t = e.previousSibling), jn(t) ? as(t, t.data.length) : as.after(t)),
        )
      : e.previousSibling
  ...
  function og(n) {
    return dn(
      rg(n.cells, n.rng.start),
      rg(n.cells, n.rng.end),
      function (e, t) {
  ...
  function kg(u, s, e) {
    var t,
      n =
        ((t = s),
        _e(_e({ format: "html" }, e), { set: !0, content: Eg(t) ? "" : t })),
  ...
  function jg(e, t, n, r) {
    ...
    i &&
      (o
        ...
        : ((s = Hc(e.getBody(), i)),
          (d = c = Ig(!1).dom),
          (p = (g = e.dom).getParent((m = null !== s ? s : i), A(tl, e))) &&
          g.isEmpty(p)
  ...
  function Pp(e, r, o, t, i) {
    ...
    if ("all" !== r.remove) {
      Nh(r.styles, function (e, t) {
        (e = il(u, rl(e, o), t + "")),
          E(t) && ((t = e), (i = null)),
          (!r.remove_similar && i && !kh(al(u, i, t), e)) ||
            u.setStyle(b, t, ""),
          (n = !0);
      }),
        n &&
  ...
  function Ip(u, s, c, e, l) {
    ...
    if ("false" !== h.getContentEditable(r.getNode()))
      ...
      for (
        var o = 0;
        o < m.length && (!m[o].ceFalseOverride || !Lp(u, m[o], c, e, e));
        o++
      );
      yf(u, s, e, c);
    }
  ...
  function sh(e, t) {
    return (
      !(!e || !t) && ((r = t), ah(e) === ah(r) || ((n = t), uh(e) === uh(n)))
    );
    var n, r;
  }
  function ch(e) {
    ...
    return {
      undoManager: {
        ...
        transact: function (e, t, n) {
          return (
            (o = n), fh((r = e), t), r.beforeChange(), r.ignore(o), r.add()
          );
          var r, o;
        },
        ignore: function (e, t) {
      ...
      formatter: {
        ...
        toggle: function (e, t, n) {
          ...
          (!Bg(r, o, i, a) || ("toggle" in u[0] && !u[0].toggle) ? Rh : Ip)(
            r,
            o,
            i,
            a,
        ...
        getContent: function (e, t) {
          return (
            ...
            ve
              .from(d.getBody())
              .fold(
                J("tree" === m.format ? new Ud("body", 11) : ""),
                function (e) {
                  return (
                    (t = d),
                    (r = e),
      ...
      return (
        ...
        t.filter(_n).map(function (e) {
          var t = u,
            ...
            i = (n ? r : o).length;
          n
            ? (zm(r, o, !1, !n), t.setStart(o, i))
            : (zm(o, r, !1, !n), t.setEnd(o, i));
        })
      );
    }).orThunk(function () {
      var e = s;
  ...
  function Ph(e) {
    return (
      e && e.ownerDocument && Ve(Nt.fromDom(e.ownerDocument), Nt.fromDom(e))
    );
  }
  function Lh(a, u, e, s) {
    function t(e, t) {
    ...
    var l,
      ...
      h = function (e, t) {
        ...
        if (
          (r = e) &&
          (Bh(r) || (Ph(r.startContainer) && Ph(r.endContainer)))
        ) {
          var r,
            o = Bh(e) ? e : null;
          if (o) {
    ...
    var o,
      ...
      h =
        ((i =
          ...
          (0,
          (f = (l = u).sections()),
          Zh(l, "mobile") && "mobile" === f.mobile.theme)
            ? U(c, A(D, Nv))
            : a && Zh(u, "mobile")
            ? c
            : s)),
  ...
  function jv(e) {
    return (
      e + ly++ + ("s" + new Date().getTime().toString(36) + t() + t() + t())
    );
    function t() {
                    ...
                    return (
                      ...
                      l.getParam("images_replace_blob_uris", !0, "boolean")
                        ...
                        : e.error &&
                          ...
                          Iv(
                            l,
                            uu.translate(["Failed to upload image: {0}", n]),
                          )),
                      {
                        element: u,
                        status: e.status,
    ...
    var s,
      ...
      l =
        (s = e.selector) && "string" == typeof s
          ...
          : [],
      f = l.length
        ? (l[0].name || (l[0].name = c), (c = e.selector), Xv(l, n))
        : Xv([c], n),
  ...
  function pb(e, t, n) {
    return (
      ...
      gb(!1, n),
      (Ve((o = n), (r = t))
        ? ((i = hm(r, o)), ve.from(i[i.length - 1]))
        : ve.none()
      ).fold(A(mb, e, t, n), A(db, e, t, n))
    );
    var r, o, i;
  }
  function hb(e, t, n, r) {
    ...
    return (
      e
        ...
        : function (e) {
            if (xy(e.nextSibling))
              return (
                Ib(e.nextSibling) || e.nextSibling.insertData(0, Co),
                e.nextSibling
              );
  ...
  function Jb(e) {
    return (
      !1 ===
      ((t = Ny(e)),
      "rtl" === Ja.DOM.getStyle(t, "direction", !0) ||
        ((n = t.textContent), py.test(n)))
    );
    var t, n;
  }
  function Qb(e, t, n) {
  ...
  function DC(e, t, n) {
    n && !e.get()
      ? t.on("NodeChange", AC, !0)
      : !n && e.get() && t.off("NodeChange", AC),
      e.set(n);
  }
  function TC(n, r) {
    var e = r.container(),
  ...
  function PC(e) {
    ...
    return (
      ...
      (c = e).on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = e),
          F0([{ keyCode: Bf.SPACEBAR, action: M0(BC, c) }], t).each(
            function (e) {
              t.preventDefault();
            },
          ));
      ...
      if (s === u + 1 && a === e.endContainer) {
        ...
        if (f(c))
          return (function (e) {
            ...
            return (
              Y(
                hu(Nt.fromDom(l.getBody()), "*[data-mce-selected]"),
                function (e) {
                  je(o, e) || yn(e, S);
                },
              ),
        ...
        l.on(
          ...
          function (e) {
            var t = e.target,
              n = s1(l, t);
            P1(n)
              ? (e.preventDefault(), wb(l, n).each(p))
              : f(t) && wb(l, t).each(p);
          },
          !0,
        ),
  ...
  function v1(t, e) {
    ...
    (N = k),
      ...
      (w = y.getParam(
        "placeholder",
        gc.getAttrib(y.getElement(), "placeholder"),
        "string",
      )),
      (S = function (e, t) {
        var n, r, o;
        !(function (e) {
          ...
          (r =
            !(
              eb((o = e)) &&
              !(tb(o) || ("keyup" === o.type && 229 === o.keyCode))
            ) &&
            (function (e, t, n) {
      ...
      X(a)
        ? ((o.settings.theme = y1(a)),
          ...
          o.theme.init &&
            o.theme.init(
              o,
              Bv.urls[a] || o.documentBaseUrl.replace(/\/$/, ""),
              o.$,
            ))
        : (o.theme = {}),
      (s = []),
        ...
        mu((r = e))
          ...
          : ((u = o),
            ...
            (s = U(du((a = r), "class"), function (e) {
              ...
              ? pn(a, "class", s.join(" "))
              : yn(a, "class")),
        0 === (mu((i = r)) ? i.dom.classList : du(i, "class")).length &&
          yn(i, "class"))
      : n && gu(e, t);
  }
  function Y1(e, t, n) {
  ...
  function ix(e, t) {
    ...
    var n = Os(e);
    return n
      ? (e.eventRoot || (e.eventRoot = dx.select(n)[0]), e.eventRoot)
      : e.getBody();
  }
  function ax(e, t, n) {
    var r, o, i, a;
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(ix(n, e), e, n.delegates[e]),
  ...
  var xx = Ja.DOM,
    ...
    kx =
      ...
      (_x.prototype.resetContent = function (e) {
        void 0 === e
          ? Yh(this, this.startContent, { format: "raw" })
          : Yh(this, e),
      ...
      (_x.prototype.getElement = function () {
        return (
          this.targetElm || (this.targetElm = xx.get(this.id)), this.targetElm
        );
      }),
  ...
  function _x(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        ...
        Ja.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy,
        )),
  ...
  function Rx(e) {
    e !== Mx &&
      (e
        ? Wa(window).on("resize scroll", Ax)
        : Wa(window).off("resize scroll", Ax),
      (Mx = e));
  }
  function Dx(t) {
    var e = Ux;
  ...
  var Tx,
    ...
    Hx = _e(_e({}, fx), {
              ...
              r.types
                ? Px(r.types, function (t) {
                    Et.each(o, function (e) {
                      return (
                        !Ox.is(e, t.selector) || (n(u(e), Lx({}, r, t), e), !1)
                      );
                    });
                  })
                : (Et.each(o, function (e) {
            ...
            return (
              ...
              l(r.get(n.id))
                ...
                : (Dx(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === Ux.length &&
                    window.removeEventListener("beforeunload", Tx),
                  n.remove(),
                  Rx(0 < Ux.length),
                  n)
            );
      ...
      _setBaseUrl: function (e) {
        (this.baseURL = new Kd(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, ""),
        )),
          (this.baseURI = new Kd(this.baseURL));
      },
    ...
    dw =
      ...
      (mw.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          (e =
            void 0 === (e = sw.parse(e)) ? { error: "JSON Parse error." } : e)
            .error
